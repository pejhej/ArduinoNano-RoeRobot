 ...
 //--------------------------------------------------------------------------------------------------
  ...
  //--------------------------------------------------------------------------------------------------
    case calibParam:
      ...
      //Add the values
      response[1] =  *((uint8_t*) & (calibratedPos.x) + 1); //high byte (0x12)
      response[2] =  *((uint8_t*) & (calibratedPos.x) + 0);
     response[3] =  *((uint8_t*) & (calibratedPos.y) + 1); //high byte (0x12)
      response[4] =  *((uint8_t*) & (calibratedPos.y) + 0);
