...
#define X_PULLEY_DIAMETER 48 // Defined i
// variables holding direction of turning
int left = 1;
int right = -1;

#define driver_microsteps 0.25
#define belt_presetPitch 3 //mm 
#define pulleyTooth 20 
...
//--------------------------------------------------------------------------------------------------
 ...
 //--------------------------------------------------------------------------------------------------
      ...
      //Set state
        ...
        calibratedPos.x = xPosition;
        calibratedPos.y = yPosition;
